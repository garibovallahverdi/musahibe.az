...
const RelatedCard:React.FC<RelatedCardListProps> = ({  title }) => {
  ...
  return (
    <div
    className={`max-w-sm p-2 gap-3 items-center mx-auto relative bg-backgroundSecond rounded-lg shadow-md overflow-hidden flex` }>   
      ...
      <div className="flex flex-col gap-2 cursor-pointer">
        <h2 className="text-[10px] font-semibold line-clamp-3">{title}</h2>
